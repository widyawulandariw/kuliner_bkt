...
?>
    <tr>
      ...
      <div class="btn-group">
        <a href="act/delete_fasilitas.php?id=<?php echo $id; ?>" onclick="return confirm('Are You Sure Want To Delete?')" class="btn btn-round btn-default" title='Delete'><i class="fa fa-trash"></i> Delete</a>
        </div>
