    ...
    <table>
		...
		<table class="table table-hover table-bordered table-striped">
			...
			<table class="table table-hover table-bordered table-striped">
				...
				<br><tr><td>
					<a href="?page=formlfas&id=<?php echo $id ?>" class="btn btn-round btn-warning"><i class="fa fa-plus-square"></i> Add Information</a>
				</td></tr>

				
					<table id="addinfo" class="table">
					<form method="POST" action="lombikinbep.php">
                        <tbody  style='vertical-align:top;'>
