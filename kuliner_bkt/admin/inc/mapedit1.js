...
function initialize(){
  ...
  oleh_oleh_reg = new google.maps.Data();
  oleh_oleh_reg.loadGeoJson('act/oleh_oleh_region.php?id_oleh_oleh='+id_oleh_oleh.value);
  oleh_oleh_reg.setMap(map);
  oleh_oleh_reg.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  });
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  oleh_oleh_reg.addListener('addfeature', function(e) {
