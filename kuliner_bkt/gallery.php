         ...
         for (var i in rows) 
          { 
            ...
            map.setZoom(18); 
                ...
                $('#detgal').append("<tr><td>Nama</td><td>:</td><td> "+namaa+"</td></tr><br><tr><td>Alamat</td><td>:</td><td> "+address+"</td></tr><br><tr><td>Telepon</td><td>:</td><td> "+cp+"</td></tr><br><tr><td>Open</td><td>:</td><td> "+open+"</td></tr><br><tr><td>Close</td><td>:</td><td> "+close+"</td></tr><br><tr><td>Capacity</td><td>:</td><td> "+capacity+"</td></tr>br><tr><td>Facility</td><td>:</td><td> "+fasilitas+"</td></tr><tr><td><b> Culinary </b></td><td></td><td><b> Price </b></td></tr>");
