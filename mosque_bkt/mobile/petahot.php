...
<script type='text/javascript'> 
 function init(){
  ...
  kecamatan = new google.maps.Data();
    ...
    var marker0 = new google.maps.Marker({ position: latlng,  icon:'../assets/ico/marker_hotel.png', map: map,title: '', animation: google.maps.Animation.DROP, clickable:false}); 
