                      ...
                      while ($rows = pg_fetch_array($result)) 
                        {
                          ...
                          echo "<tr><td>$tgl</td><td>$info</td><td><a href='act/deleteinfoc.php?id_informasi=$id_info' class='btn btn-sm btn-default' title='Delete'><i class='fa fa-trash-o'></i></a></td></tr>";
                        }
