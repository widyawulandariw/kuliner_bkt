<?php
$id=$_GET['id'];
$sql = pg_query("SELECT nama_industri,ST_AsText(geom) as geom FROM industri_kecil_region where id=$id");
	...
	<div class="">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title" style="text-transform:capitalize;">Ubah Data Spasial <?php echo $data['nama_industri'] ?></h3>
			</div>
			<div class="box-body">
				...
				<form role="form" action="act/editspasialprocess.php" method="post">
					...
					<a href="?page=detail&id=<?php echo $id ?>" class="btn btn-default btn-sm"><i class="fa fa-chevron-left"></i> Kembali</a>
