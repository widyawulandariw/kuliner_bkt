...
function initialize(){
  ...
  var infowindow = new google.maps.InfoWindow;
   ...
   //menampilkan digitasi kul
  souvenir_reg = new google.maps.Data();
  souvenir_reg.loadGeoJson('act/souvenir_region.php?id='+id.value);
  souvenir_reg.setMap(map);
  souvenir_reg.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  });
  //zoom peta sesuai digitasi
  var bounds = new google.maps.LatLngBounds();
  souvenir_reg.addListener('addfeature', function(e) {
